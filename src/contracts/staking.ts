...
import { ScriptReferences, StakingParams, SystemParams } from '../types/system-params';
...
export class StakingContract {
    ...
    static decodeDatum(datum: string): StakingDatum {
        ...
        if (stakingDatum.index === 0 && stakingDatum.fields[0].index === 0) {
            ...
            for (const [key, value] of (positionDatum[1] as Map<bigint, Constr<bigint>>)) {
